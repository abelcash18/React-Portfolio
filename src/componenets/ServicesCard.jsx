...
const ServicesCard = ({ serviceTitle, servicesImg }) => {
  ...
  return (
    ...
    >
    <div className='bg-[#ffffff2a] border border-[#ffffff2a] hover:translate-y-2 overflow-hidden rounded-[35px] flex flex-col justify-between h-100 gap-[2em] transition-all duration-300 ease-in-out backdrop-blur-[5px]'>
      <div className='flex items-center border-b justify-between py-3.75 px-5'>
        ...
        <div className='w-full h-[300px] flex flex-col relative justify-end beforeBg'>
          <div style={{justifyContent: 'space-between'}} className='w-full h-[90%] object-fit-cover'>
            <img className='w-full h-[100%]' src={servicesImg} alt={`${serviceTitle} preview`} />
          </div>
        </div>
    </div>
    </motion.div>
